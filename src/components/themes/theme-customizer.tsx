...
@layer base {
  :root {
    ...
    --chart-6: <%- colors.light["chart-6"] %>;
    --chart-7: <%- colors.light["chart-7"] %>;
    --chart-8: <%- colors.light["chart-8"] %>;
    --chart-9: <%- colors.light["chart-9"] %>;
    --chart-10: <%- colors.light["chart-10"] %>;
    --chart-11: <%- colors.light["chart-11"] %>;
  }
  ...
  .dark {
    ...
    --chart-6: <%- colors.dark["chart-6"] %>;
    --chart-7: <%- colors.dark["chart-7"] %>;
    --chart-8: <%- colors.dark["chart-8"] %>;
    --chart-9: <%- colors.dark["chart-9"] %>;
    --chart-10: <%- colors.dark["chart-10"] %>;
    --chart-11: <%- colors.dark["chart-11"] %>;
  }
}
`
