...
import type { createFileTreeForRegistryItemFiles, FileTree } from "@/lib/registry-server"
  ...
  return (
    ...
    >
      <div
        ...
        style={
          {
            "--height": item.meta?.iframeHeight ?? "530px",
...
function BlockViewerIframe({
  ...
  return (
    <iframe
      ...
      height={item.meta?.iframeHeight ?? 530}
      loading="lazy"
      className={cn(
...
function BlockViewerCode() {
  ...
  return (
    <div className="bg-code text-code-foreground mr-[14px] flex overflow-hidden rounded-xl border group-data-[view=preview]/block-view-wrapper:hidden md:h-(--height)">
      ...
      >
        <figcaption
          className="text-code-foreground [&_svg]:text-code-foreground [&_svg]:rounded-xs flex h-12 shrink-0 items-center gap-2 border-b px-4 py-2 [&_svg]:size-4 [&_svg]:opacity-70"
